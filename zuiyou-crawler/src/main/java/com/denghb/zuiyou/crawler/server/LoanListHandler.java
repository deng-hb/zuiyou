package com.denghb.zuiyou.crawler.server;

import com.denghb.zuiyou.domain.Loan;
import com.denghb.zuiyou.crawler.server.utils.HtmlUtils;
...
public class LoanListHandler implements Runnable {
    ...
    /** 期限倒序 */
    static String PPDAI_LOANLIST_URL = "http://invest.ppdai.com/loan/listnew?LoanCategoryId=%d&PageIndex=%d&SortType=10";
